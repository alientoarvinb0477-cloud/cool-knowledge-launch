const Footer = () => (
  <footer className="bg-navy-light py-10">
    <div className="container mx-auto px-4 text-center">
      <div className="flex justify-center gap-6 mb-6">
        ...
        <a
          href="https://www.tiktok.com/@coolknowledgeenterprises"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary-foreground/60 hover:text-primary transition-colors"
          aria-label="TikTok"
        ...
        <a
          href="https://www.youtube.com/@coolknowledgeenterprises"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary-foreground/60 hover:text-primary transition-colors"
          aria-label="YouTube"
      ...
      <p className="text-primary-foreground/50 text-sm">
        © {new Date().getFullYear()} Cool Knowledge Enterprises. All rights reserved.
      </p>
    </div>
  </footer>
);
